    ...
    <div id="nav" class="flex items-center h-10">
      ...
      <button class="px-1 mr-2 h-10 text-xs font-medium tracking-wider text-green-500 uppercase rounded-lg focus:outline-none hover:text-green-700" title="Filter">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M11 15C10.7348 15 10.4804 15.1054 10.2929 15.2929C10.1054 15.4804 10 15.7348 10 16C10 16.2652 10.1054 16.5196 10.2929 16.7071C10.4804 16.8946 10.7348 17 11 17H13C13.2652 17 13.5196 16.8946 13.7071 16.7071C13.8946 16.5196 14 16.2652 14 16C14 15.7348 13.8946 15.4804 13.7071 15.2929C13.5196 15.1054 13.2652 15 13 15H11Z" class="fill-current"/>
        </svg>
      </button>
    </div>
    <div class="flex overflow-y-auto flex-1 mx-2 mb-2 bg-white rounded-xl no-scrollbar">
      <router-view/>
    </div>
  </div>
</template>
